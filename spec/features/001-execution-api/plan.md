...
Módulo de feature con controller y DTOs explícitos, `ExecutionService` y repositorio de estado operativo. Implementar `202 + polling`, idempotencia, auth/correlación y filtros de error según `INTEROP-2.1`; no retornar entidades internas directamente ni convertir ese estado local en persistencia autoritativa del producto.
