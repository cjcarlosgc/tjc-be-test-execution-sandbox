...
- [x] Result models. — `RunnerFacts`/`TestCaseFact`/`StageDuration`/`ExecutionEvidenceFact` (`INTEROP-2.1` §7.3) poblados por `ExecutionPipelineService` al completar `RUNNING_TESTS`.
