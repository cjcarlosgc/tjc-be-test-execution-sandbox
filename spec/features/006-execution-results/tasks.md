...
- [x] Result models. — `RunnerFacts`/`TestCaseFact`/`StageDuration`/`ExecutionEvidenceFact` (`INTEROP-1.6` §7.3) poblados por `ExecutionPipelineService` al completar `RUNNING_TESTS`.
