...
- Todo error HTTP usa `ErrorEnvelope` de `INTEROP-2.0` y conserva `x-correlation-id`.
...
- La URL expirada, descarga fallida e integridad inválida usan los códigos de `INTEROP-2.0` sin incorporar la URL ni su token al mensaje persistido.
