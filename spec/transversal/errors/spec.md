...
- Todo error HTTP usa `ErrorEnvelope` de `INTEROP-1.1` y conserva `x-correlation-id`.
...
- La URL expirada, descarga fallida e integridad inválida usan los códigos de `INTEROP-1.1` sin incorporar la URL ni su token al mensaje persistido.
